...
;----------------------------------------------------------------------------
    ...
    mov ebp, 0x00200000 ; comment here ; 0x7c92:
    mov esp, ebp
...
;----------------------------------------------------------------------------
    ...
    mov cl, 2 ; for the 100 Sectors, defined in the Makefile
    mov edi, 0x0100000 ; 1 Mebibyte, or 1048576 bytes -> Address where to load the sectors into  ;0x7caf:
...
;-----------------------------------------------------------------------------
    ...
    jmp CODE_SEG:0x0100000 ; jump to the loaded Data, problem with VMWARE! HERE! ;0x7cbc:      ljmp   $0x8,$0x100000
...
check_disk:
    ...
    cmp ebx, 0x0001fbe8 ; first db of sector1 (Signature)
...
string: db 'M:OS Bootloader starting...                                      ', 0
stringCR: db 'M:OS Bootloader cant read Sector [1]                              ', 0
